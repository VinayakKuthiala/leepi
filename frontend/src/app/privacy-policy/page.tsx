        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              At Leepi ("we," "our," or "us"), we are committed to protecting your privacy and ensuring the security of 
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mt-3">
                  This information may include: name, email address, phone number, billing and shipping addresses, 
              ...
              <div>
                <h3 className="text-xl font-medium text-gray-900 mb-3">Cookies and Tracking Technologies</h3>
                <p className="text-gray-700 leading-relaxed">
                  We use cookies, web beacons, and similar tracking technologies to enhance your experience on our website. 
                  These technologies help us remember your preferences, understand how you use our site, and improve our services.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  including payment processors, shipping companies, email service providers, and analytics providers. 
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  part of the transaction. We will notify you of any such change in ownership or control of your 
                  personal information.
                </p>
              </div>

              <div>
                <h3 className="text-xl font-medium text-gray-900 mb-3">Consent</h3>
                <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              secure servers, firewalls, and access controls. However, no method of transmission over the internet or 
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              such transfers are made in accordance with applicable data protection laws and that appropriate safeguards 
          ...
          <section>
            ...
            <div className="p-4 bg-gray-50 rounded-lg space-y-2">
              <p className="text-gray-700"><strong>Email:</strong> privacy@leepi.com</p>
              <p className="text-gray-700"><strong>Phone:</strong> +1 (555) 123-4567</p>
              <p className="text-gray-700"><strong>Address:</strong> 123 Business Street, City, State 12345</p>
              <p className="text-gray-700"><strong>Data Protection Officer:</strong> dpo@leepi.com</p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              as described in this privacy policy. If you do not agree with any part of this policy, please do not use 
              our services.
            </p>
          </section>
        </div>
