    ...
    <div className="min-h-screen bg-gradient-to-b from-indigo-50 via-white to-rose-50">
      ...
      <main className="container mx-auto py-16 px-4 md:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          {/* Contact Form */}
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden relative flex flex-col h-full">
            {/* Decorative element */}
            ...
            <div className="p-8 md:p-12 relative flex-grow flex flex-col">
                    ...
                    render={({ field }) => (
                      <div>
                        ...
                        <input
                          {...field}
                          type="text"
                          className="w-full text-black px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent"
                        />
                      </div>
                    )}
                  />
